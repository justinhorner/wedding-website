$(document).ready(function () {
    ...
    for (var i = 0; i < share_bar.length; i++) {
        var html = '<iframe allowtransparency="true" frameborder="0" scrolling="no"' +
            'src="https://platform.twitter.com/widgets/tweet_button.html?url=' + encodeURIComponent(window.location) + '&amp;text=' + encodeURIComponent(document.title) + '&amp;via=justinhorner&amp;hashtags=husbandshorner&amp;count=horizontal"' +
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Justin and Meg's Wedding",

            // Event start date
            start: new Date('Apr 13, 2019 17:00'),
            ...
            end: new Date('Apr 13, 2019 23:00'),

            // Event Address
            address: '703 E Country Plaza S, Gilbert, AZ 85234',
